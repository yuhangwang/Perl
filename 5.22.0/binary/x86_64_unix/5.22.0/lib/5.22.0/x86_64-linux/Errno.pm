...
"x86_64-linux-2.6.32-504.16.2.el6.x86_64" or
	die "Errno architecture (x86_64-linux-2.6.32-504.16.2.el6.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
